...
SplitScreen(Position) {
    ...
    if (Position = 1) {
        ResizeWindow(0, HalfWidth, HalfHeight, 0)  ; Top Left
    } else if (Position = 2) {
        ResizeWindow(0, 0, HalfHeight, HalfWidth)  ; Top Right
    } else if (Position = 3) {
        ResizeWindow(HalfHeight, HalfWidth, 0, 0)  ; Bottom Left
    } else if (Position = 4) {
        ResizeWindow(HalfHeight, 0, 0, HalfWidth)  ; Bottom Right
    } else if (Position = 5) {
        ; Left 50% of screen
        ResizeWindow(0, HalfWidth, 0, 0)
    } else if (Position = 6) {
        ; Right 50% of screen
        ResizeWindow(0, 0, 0, HalfWidth)
    }
}
